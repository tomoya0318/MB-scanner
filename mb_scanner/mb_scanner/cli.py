"""トップレベル CLI: 各パイプライン段の Typer アプリを統合する composition root。"""

from typer import Typer

from mb_scanner.equivalence.cli import equivalence_app
from mb_scanner.preprocessing.cli import preprocessing_app
from mb_scanner.pruning.cli import pruning_app
