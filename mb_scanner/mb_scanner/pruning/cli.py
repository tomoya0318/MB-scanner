...
from mb_scanner.pruning.gateway import (
    INTERNAL_KEY_PREFIX,
...
def _run_batch(
    ...
    *,
    ...
    with ThreadPoolExecutor(max_workers=workers) as executor:
        futures = {executor.submit(pruner.prune_batch, batch): batch_idx for batch_idx, batch in enumerate(batches)}
...
def prune(
    ...
    result = gateway.prune(input_model)
