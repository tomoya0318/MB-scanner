...
- **Status**: accepted
- **Date**: 2026-05-05
- **Related**: PR #4, `mb-analyzer/src/preprocessing/common/enclosure.ts`, `mb-analyzer/src/preprocessing/selakovic/index.ts`, `ai-guide/code-map.md` §Selakovic 前処理器, `tmp/0004_hydra-pruning-integration/plan.md` §Phase 4.2
