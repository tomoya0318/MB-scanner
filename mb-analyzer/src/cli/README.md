...
```jsonc
{"id": "case-1", "slow": "...", "fast": "...", "timeout_ms": 5000, "setup": "..."}
{"id": "case-2", "slow": "...", "fast": "...", "timeout_ms": 5000}
```
...
|---|---|
| 0 | `verdict === "pruned"` |
| 1 | `verdict === "initial_mismatch"` (slow ≢ fast 入力ミス) |
...
```jsonc
{"id": "case-1", "slow": "...", "fast": "...", "timeout_ms": 2000, "max_iterations": 200}
{"id": "case-2", "slow": "...", "fast": "...", "timeout_ms": 2000}
```
