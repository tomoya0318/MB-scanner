 ...
 *   - EquivalenceInput: slow/fast 必須、setup/timeout_ms/environment/module_base_dir/mount_html は任意
...
describe("EquivalenceInput", () => {
  it("slow / fast 必須、それ以外 (setup / timeout_ms / environment / module_base_dir / mount_html) は任意", () => {
